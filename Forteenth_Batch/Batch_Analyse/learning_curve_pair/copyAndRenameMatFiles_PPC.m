function copyAndRenameMatFiles_PPC(InputPath)
...
lightDestDir = fullfile(parentPath, 'PPC_Group', StimuliName, 'light');
odourDestDir = fullfile(parentPath, 'PPC_Group', StimuliName, 'odour');
