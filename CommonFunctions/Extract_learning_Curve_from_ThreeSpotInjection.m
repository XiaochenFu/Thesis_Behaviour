...
Data_Path = 'C:\Users\yycxx\OneDrive - OIST\Thesis\Behaviour\Group_Analyses\Learning_Curve_Fibre_In_Threespot\learning_curve';
cd(Data_Path)
ResultPath = 'C:\Users\yycxx\OneDrive - OIST\Thesis\Behaviour\Group_Analyses\Learning_Curve_Fibre_In_Threespot\learning_curve_group';
Result_Title = '3Spot';
...
legend([p1 p2 p3 ],'Location', 'bestoutside','NumColumns',1);
...
ylim([-5 5])
legend([ p25 p50 p75 ],'Location', 'bestoutside','NumColumns',1);
